...
export const demoEvents = [
  ...
  { type: "tool_end", run_id: "kb", name: "search_local_knowledgebase", text: "需求核对完成：50 名成员，峰值 8 路请求；本地文档 18,400 份；离线运行；年度预算 300,000 元。[内部需求 §2–4 · 演示数据]" },
  ...
  { type: "tool_end", run_id: "papers", name: "arxiv", text: "研究资料分组：检索质量、引用可追溯性、生成结果核查；建立独立验收维度。[研究资料摘要 · 演示数据]" },
