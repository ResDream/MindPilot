...
from ..knowledge_base.kb_api import list_kbs
from ..knowledge_base.kb_doc_api import DocumentWithVSId, search_docs
from ..utils.pydantic_v1 import Field
...
def search_local_knowledgebase(
    ...
    """
        Search the local knowledgebase for documents related to the given query.
    """
